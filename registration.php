...
<title>Heterogenous Banking System Sign Up</title>
...
<table cellpadding="0" cellspacing="0" style="margin:auto; width:100%; " >
    ...
    <tr><td colspan="2"  align="center"><img src="Images/logo1.png" width="300px" height="80px"  /></td></tr>
   
<tr><td colspan="2">&nbsp;</td></tr>
   
                <tr><td  style=" padding-left:20px;" ><img src="Images/bank1.png" width="170px" class="shaddoww"/>&nbsp; </td>
                    <td style="vertical-align:top;padding-top:20px;">
                    <table cellpadding="0" cellspacing="0" style="width:100%; height:400px;">

<tr><td class="lefttd">Name:</td><td><input type="text" name="t1" required="required" pattern="[a-zA-Z _]{4,15}" title="please enter only character  between 4 to 15 for name" /></td></tr>
...
<tr><td class="lefttd">Bdate</td><td><input type="date" name="t4" required="required" pattern="[0-9]{2,10}" title="please enter only character or numbers between 2 to 10 for password" /></td></tr>
...
//aloow certain file formats
	if($imageFileType != "jpg" && $imageFileType !="png" && $imageFileType !="jpeg" && $imageFileType !="gif"){
		...
		$cn=makeconnection();
			$s="insert into userdetails(name,age,gender,mobile_no,birthday,email,pwd,pic) values('" . $_POST["t1"] ."','" . $_POST["t2"] . "','" . $_POST["r1"] . "','" . $_POST["t3"] . "','" . $_POST["t4"] . "','" . $_POST["t5"] . "','" . $_POST["t6"] .  "','" . basename($_FILES["t8"]["name"])  ."')";
			
			//$s="INSERT INTO userdetails(name,gender,age,mobile_no,birthday,email,pwd,pic) VALUES ([value-1],[value-2],[value-3],[value-4],[value-5],[value-6],[value-7],[value-8],[value-9])"
	$q=mysqli_query($cn,$s);
	mysqli_close($cn);
	if($q>0)
	{
